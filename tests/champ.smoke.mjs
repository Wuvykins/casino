// Visual check of the tournament-champion ceremony: sit at a Sit & Go, then run the ceremony directly over the table
...
for (const [tag, viewport, safe] of [['phone', { width: 844, height: 390 }, true], ['ipad', { width: 1180, height: 820 }, false]]) {
  ...
  const run = page.evaluate(async () => {
    ...
    await championship({ winner: 'Nic', prize: 800, players: 6, tableName: 'Sit & Go $200' });
    return 'collected';
  });
