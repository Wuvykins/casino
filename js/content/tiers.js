...
export const TIERS = [
  ...
  { id: 2, name: 'Silver',    min: 5000,    colors: ['#d9dde3', '#8f98a3'], text: '#22282f' },
  { id: 3, name: 'Gold',      min: 25000,   colors: ['#f2d16b', '#a67c1d'], text: '#2b2000' },
  { id: 4, name: 'Platinum',  min: 100000,  colors: ['#f4f4f6', '#b9bcc6'], text: '#1c2340' },
  { id: 5, name: 'Sovereign', min: 500000,  colors: ['#2a2a2e', '#000000'], text: '#e6d38a' },
];
