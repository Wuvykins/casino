...
//                                                                  assets/voice/<id>/<trigger>_1.m4a, _2.m4a ...
...
//               e.g. fold: [{ text: "Not with that.", file: "fold_1.m4a" }, "Nope."]
//
// Triggers: greet, fold, check, call, raise, allin, winSmall, winBig, lose, badBeat, caughtBluff,
//           hurry, bustOut, rebuy, playerBust, playerWin, idle
...
export const CHARACTERS = [
  {
    ...
    persona: { skill: 0.9, tight: 0.8, aggro: 0.6, bluff: 0.15, tilt: 0.1 },
    lines: {
  ...
  },
  {
    ...
    persona: { skill: 0.45, tight: 0.2, aggro: 0.95, bluff: 0.85, tilt: 0.5, shove: 0.4 },
    lines: {
  ...
  },
  {
    ...
    persona: { skill: 0.15, tight: 0.15, aggro: 0.05, bluff: 0.02, tilt: 0.2 },
    lines: {
  ...
  },
  {
    ...
    persona: { skill: 0.4, tight: 0.75, aggro: 0.3, bluff: 0, tilt: 0.2, pairLover: 0.75 },
    lines: {
  ...
  },
  {
    ...
    persona: { skill: 0.5, tight: 0.5, aggro: 0.55, bluff: 0.2, tilt: 0.15 },
    lines: {
